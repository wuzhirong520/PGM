...
CUDA_VISIBLE_DEVICES=1 python src/pretrain.py --dataset "ESOL"          --run_name "pretrain-ESOL-001"          --seed 666 --num-epochs 200 --batch_size 32 --learning_rate 0.001 --save_ckpt_step 1 --log_path ./log --split scaffold --split-ratio "0.8,0.1,0.1" --num-workers 0 --wandb &
CUDA_VISIBLE_DEVICES=2 python src/pretrain.py --dataset "FreeSolv"      --run_name "pretrain-FreeSolv-001"      --seed 666 --num-epochs 200 --batch_size 32 --learning_rate 0.001 --save_ckpt_step 1 --log_path ./log --split scaffold --split-ratio "0.8,0.1,0.1" --num-workers 0 --wandb &
CUDA_VISIBLE_DEVICES=3 python src/pretrain.py --dataset "Lipophilicity" --run_name "pretrain-Lipophilicity-001" --seed 666 --num-epochs 200 --batch_size 32 --learning_rate 0.001 --save_ckpt_step 1 --log_path ./log --split scaffold --split-ratio "0.8,0.1,0.1" --num-workers 0 --wandb &
